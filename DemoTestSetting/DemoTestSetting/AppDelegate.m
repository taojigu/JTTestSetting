...
- (void)initTestSetting {
    JTTestSettingModel *model = [[JTTestSettingModel alloc] init];
    model.uniqKey = @"ApiBaseURLString";
    model.name = @"api 基地址";
    model.settingType = JTTestSettingTypeTextString;
    model.active = NO;
    JTTestSettingManager *manager = [[JTTestSettingManager alloc] init];
    [manager configureSettingModleArray:@[model]];
}
